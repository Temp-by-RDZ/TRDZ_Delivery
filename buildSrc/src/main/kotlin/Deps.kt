object Deps {
	...
	const val COROUTINES_SERVICE = "org.jetbrains.kotlinx:kotlinx-coroutines-play-services:1.4.1"
	//Data Room
	const val ROOM_CORE = "androidx.room:room-runtime:2.3.0"
	const val ROOM_COMPILER = "androidx.room:room-compiler:2.3.0"
	const val FIREBASE = "acom.google.firebase:firebase-firestore-ktx:24.1.2"
	const val FIREBASE_CRT = "org.jetbrains.kotlinx:kotlinx-coroutines-play-services:1.4.1"
	//Data Server
	const val FIRESTORE_CORE = "com.google.firebase:firebase-firestore-ktx:24.1.2" //FireStore Server
